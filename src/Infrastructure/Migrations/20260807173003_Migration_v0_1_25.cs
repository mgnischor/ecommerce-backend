        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_spending = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    ...
                    historical_average_order_days = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    card_number = table.Column<string>(type: "character varying(19)", unicode: false, maxLength: 19, nullable: false),
                    balance = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    is_revoked = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    allows_reload = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reorder_point = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    average_daily_sales = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    ...
                    cost_of_goods_sold = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    average_inventory_value = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    sales_in_last_90_days = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by = table.Column<Guid>(type: "uuid", nullable: false, defaultValue: new Guid("ce06e1a8-f688-44b6-b616-4badf09d9153")),
                    updated_by = table.Column<Guid>(type: "uuid", nullable: true),
                    invoice_number = table.Column<string>(type: "character varying(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_earned_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
