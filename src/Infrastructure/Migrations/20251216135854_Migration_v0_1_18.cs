...
namespace ECommerce.src.Infrastructure.Migrations
{
    ...
    public partial class Migration_v0_1_18 : Migration
    {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    },
                    {
                        ...
                        "1.1.03.001",
                        "3.1.01.001",
                        "Sale of inventory to customers (COGS recognition)",
                        true,
                        "SALE",
                        2,
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    },
                    {
                        ...
                        "3.1.01.001",
                        "1.1.03.001",
                        "Customer returns inventory (COGS reversal)",
                        true,
                        "SALE_RETURN",
                        3,
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    ...
                    },
                    {
                        ...
                        "4.2.01.001",
                        "1.1.03.001",
                        "Positive inventory adjustment (overage)",
                        true,
                        "ADJUSTMENT_POSITIVE",
                        5,
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    },
                    {
                        ...
                        "1.1.03.001",
                        "3.2.01.002",
                        "Negative inventory adjustment (shortage)",
                        true,
                        "ADJUSTMENT_NEGATIVE",
                        5,
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    },
                    {
                        ...
                        "1.1.03.001",
                        "3.2.01.001",
                        "Inventory loss, shrinkage, or write-off",
                        true,
                        "LOSS",
                        7,
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
        ...
        {
            migrationBuilder.DropTable(name: "AccountingRules");
            ...
            migrationBuilder.DropColumn(name: "LockedUntil", schema: "public", table: "Users");
        }
    }
}
